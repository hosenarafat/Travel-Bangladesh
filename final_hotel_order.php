    ...
    <div class="w3-row" style="margin-top:-10px;margin-left: 130px;">
      ...
      <div class="w3-col s7 w3-white w3-card-4" style="height:400px;width: 650px;">
        ...
        <div style="background-color:#009999;height: 55px;margin-top: -10px;">
          <h4 style="text-align: center;margin-bottom: 5px;color: #f8f8ff; font-size: 25px;">Congratulations! Successfully Booked your Hotel</h4>
        </div>
        <hr>
        ...
        <div class="w3-row" style="height: 50px;background-color:#ff8c00;margin-top: 140px;">
          <h4 class="w3-hover-opacity" style="margin-left: 10px;font-size: 20px;color: white;">You Successfully Book your Hotel. Stay with Travel Bangladesh</h4>

        </div>

        <div class="w3-row w3-card-4" style="height: 350px;margin-top:20px;width: 650px;background-color: white">
          <div style="background-color:#009999;height: 55px;margin-top: -10px;">
            <h4 style="text-align: center;margin-bottom: 5px;color: #f8f8ff; font-size: 25px;">OUR FACILITY</h4>
          </div>
