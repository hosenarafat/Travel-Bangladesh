...
<body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="hotel_slider_image/200.jpg" alt="saint" style="width:100%; height:400px">
        ...
        <div class="item">
          <img src="hotel_slider_image/202.jpg" alt="sajek" style="width:100%;height:400px">
          <div class="carousel-caption">
            <!--     <h3>Sajek Valley</h3>
  ...
  <div class="simple-text">
    <h1 class="w3-hover-opacity" style="color:#009999;padding-top: 6px;text-align: center;font-weight: bold;">&#9748; Save up to 25% on hotels.</h1>
    <p style="padding-left: 60px; margin-top:25px;font-weight: bold;font-size: 18px;">Travel Bangladesh compares prices from many booking sites to help you find the lowest price on the right hotel for you.</p>
  </div>
