...
<body>
  ...
  <h4 style="color: #009999;font-size: 32px;font-weight: 700;margin-left: 90px">&#x26F5 Travel Bangladesh Offers Charmimg, Family-friendly & Romantic Hotels</h4>
      ...
      <div class="w3-col w3-card-4" style="width: 700px;">
        <div class="booking_options">
          <div style="background-color: #009999;height: 50px;margin-left: -20px;margin-top: -20px;">
            <p style="margin-left: 20px;">Booking Options...
            <p>
          </div>
        </div>

        <div class="seller">
          <h4>Travel Bangladesh</h4>
        </div>
              ...
              <div class="col-md-8 col-sm-8 col-xs-16">
                ...
                <div class="form_div">
                  ...
                  <form method="post">
                    ...
                    <input style="background-color:#009999" type="submit" name="btn3" value="Confirm Book ">
                  </form>
                  <!--form end-->
