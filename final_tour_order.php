    ...
    <div class="w3-row" style="margin-top:-10px;margin-left: 130px;">
      ...
      <div class="w3-col s7 w3-white w3-card-4" style="height:400px;width: 650px;">
        ...
        <div style="background-color:#009999;height: 55px;margin-top: -10px;">
          <h4 style="text-align: center;margin-bottom: 5px;color: #f8f8ff; font-size: 25px;">Congratulations! Successfully Booked your Tours Place</h4>
        </div>
        <hr>
        ...
        <div class="w3-row">
          ...
          <table class="register_table">
            ...
            <tr>
              ...
              <td>
                <h3 for="fname" style="font-size: 17px;font-weight: 20;">First Name :</h3> <?php
                                                                                            echo "<p style='color:#4d4d4d;font-size:15px;margin-left:0px;margin-top:-3px;background-color:#cccccc;height:30px;width:230px;
				border-radius:3px;text-align:justify;'>" . $fname . "</p>"; ?>
              </td>


              <td>
                <h3 for="lname" style="font-size: 17px;font-weight: 20;">Last Name :</h3> <?php
                                                                                          echo "<p style='color:#4d4d4d;font-size:15px;margin-left:0px;margin-top:-3px;background-color:#cccccc;height:30px;width:230px;
				border-radius:3px;text-align:justify;'>" . $lname . "</p>"; ?>
              </td>
            ...
            <tr>
              ...
              <td>
                <h3 for="email" style="font-size: 17px;font-weight: 20;">Email :</h3> <?php
                                                                                      echo "<p style='color:#4d4d4d;font-size:15px;margin-left:0px;margin-top:-3px;background-color:#cccccc;height:30px;width:230px;
				border-radius:3px;text-align:justify;'>" . $email . "</p>"; ?>
              </td>

              <td>
                <h3 for="phone" style="font-size: 17px;font-weight: 20;">Phone :</h3> <?php
                                                                                      echo "<p style='color:#4d4d4d;font-size:15px;margin-left:0px;margin-top:-3px;background-color:#cccccc;height:30px;width:230px;
				border-radius:3px;text-align:justify;'>" . $phone . "</p>"; ?>
              </td>
            </tr>
        ...
        <div class="w3-row" style="height: 50px;background-color:#ff8c00;margin-top: 110px;">
          <h4 class="w3-hover-opacity" style="margin-left: 10px;font-size: 20px;color: white;">You Successfully Book your Tourist Place. Stay with Travel Bangladesh</h4>
        </div>

        <div class="w3-row w3-card-4" style="height: 250px;margin-top:20px;width: 650px;background-color: white">
          <div style="background-color:#009999;height: 55px;margin-top: -10px;">
            <h4 style="text-align: center;margin-bottom: 5px;color: #f8f8ff; font-size: 25px;">ADVICE</h4>
            <?php
