...
<body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="tour_slider_image/img_bg_2.jpg" alt="saint" style="width:100%; height:400px">
        ...
        <div class="item">
          <img src="tour_slider_image/tour-2.jpg" alt="sajek" style="width:100%;height:400px">
          <div class="carousel-caption">
            <h3>Royal Bangol Tiger</h3>
            <p>Sundarban, Bangladesh</p>
          </div>
        </div>

        <div class="item">
          <img src="tour_slider_image/img_bg_3.jpg" alt="sylhet" style="width:100%; height:400px">
          <div class="carousel-caption">
            <h3>National Memorial</h3>
  ...
  <div class="w3-card-4 simple-text">
    <h2 style="color:white;padding-top: 6px;text-align: center;">Travel Bangladesh &#9748; Love tours? We have the latest and lowest price.</h2>
  ...
  <div class="row">
    <div class="col-md-4" style="width: 350px;height: 600px;margin-left:40px;">
      <div class="w3-hover-opacity w3-card-2 design_text_one" style="height: 150px;">
        <h4 style="text-align: center;background-color: #009999;color: white;height:30px;">Travel Bangladesh</h4>
        <p>&#9996; know better</p>
        <p>&#9996; go better</p>
        <p>&#9996; & book better</p>
      </div>
