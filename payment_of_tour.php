	...
	?>
		<div class="w3-row w3-card-4" style="width: 800px;height: 1100px;margin-left: 270px;margin-top: 70px;margin-bottom: 100px;">
			...
			<div class="w3-row" style="height: 120px;background-color: white">
				...
				<!--**********************modal end*******************************-->
				<div id="demo">
					<button type="submit " style="margin-left: 330px;margin-top: 20px;padding: 15px 32px;font-size: 25px;background-color: #009999;color: white" onclick="pay()">Pay Now</button>
